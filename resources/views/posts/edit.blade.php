...
@section('content')
    ...
    <form action="{{ route('posts.update', $post->id) }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('img_path') is-invalid @enderror" name="img_path" id="img_path" value="{{ $post->img_path }}" placeholder="Inserisci il percorso dell'immagine">
        </div>
